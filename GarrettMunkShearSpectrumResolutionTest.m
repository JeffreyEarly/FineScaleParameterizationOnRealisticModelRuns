%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% Tries a ranges of different horizontal and vertical resolution in order
% to understand how this affects the vertical shear spectrum for a GM IGW
% field.
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
L = 500e3;
Nxy = 512;
% Nz = WVStratification.verticalResolutionForHorizontalResolution(L,Lz,Nxy,N2=N2,latitude=31);
Nz = 700;

i = 1;

resolution(i).Nxy = 256;
resolution(i).Nz = 250;
resolution(i).L = 50e3;
i = i+1;
resolution(i).Nxy = 256;
